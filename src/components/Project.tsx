...
export function Project() {
    return <div className="flex flex-col-reverse items-center justify-between mt-8 sm:flex-row">
        <div className="h-auto">
            <h3 className="text-xs">2022 - present</h3>
            <h1 className="mt-2">This is a project name! Name wisely!</h1>
            <h2 className="sm:max-w-[80%] mb-2">Fill your project brief here. It can be the outcome of the project, or some success metrics, or a cheesy tagline.</h2>
